...
function updateAcademicExperience(profileData) {
    const academicExperience = document.getElementById('profile.academicExperience')
    academicExperience.innerHTML = profileData.academicExperience.map(experience => {
        return `
            <li>
                <h3 class="title">${experience.name}</h3>
                <p>${experience.description}</p>
...
(async () => {
    ...
    updateAcademicExperience(profileData)
